...
# CREATE 3DO DATA FROM BLENDER MESH
            ...
            if p.material_index == mat_index:
                ...
                for l in p.loop_indices:
                    ...
                    for tv in range(len(this_object['tex_vertices'])):
                        if mesh_copy.uv_layers[0].uv[l].vector[0] == this_object['tex_vertices'][tv][0] and mesh_copy.uv_layers[0].uv[l].vector[1] == this_object['tex_vertices'][tv][1]:
                            existing_tv = tv
                            break
                    ...
                    if existing_tv >= 0:
                        ...
                        this_object['tex_vertices'].append((
                            mesh_copy.uv_layers[0].uv[l].vector[0],
                            mesh_copy.uv_layers[0].uv[l].vector[1]
                        ))
...
class Export3DO(Operator, ExportHelper):
    """Export mesh to a 3DO"""
    bl_idname = "export_vue.df3do"
